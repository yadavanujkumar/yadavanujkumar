...
<p align="center">
  ...
  <circle cx="90" cy="90" r="80" fill="#F4F4F4" stroke="#E0E0E0" stroke-width="4"/>
  <ellipse cx="90" cy="120" rx="50" ry="30" fill="#E0E0E0"/>
  <circle cx="90" cy="85" r="40" fill="#FFD39F"/>
  <ellipse cx="90" cy="95" rx="18" ry="14" fill="#FFD39F"/>
  <ellipse cx="75" cy="85" rx="5.5" ry="6" fill="#fff"/>
  <ellipse cx="105" cy="85" rx="5.5" ry="6" fill="#fff"/>
  <circle cx="75" cy="86" r="2.5" fill="#333"/>
  <circle cx="105" cy="86" r="2.5" fill="#333"/>
  <rect x="74" y="105" width="32" height="8" rx="4" fill="#F8BB86"/>
  <path d="M70 70 Q90 60 110 70" stroke="#333" stroke-width="3" fill="none"/>
  <!-- Glasses -->
  <rect x="67" y="82" width="16" height="7" rx="3.5" fill="#333" opacity="0.3"/>
  <rect x="97" y="82" width="16" height="7" rx="3.5" fill="#333" opacity="0.3"/>
  <rect x="83" y="84" width="14" height="3" fill="#333" opacity="0.3"/>
  <!-- Hair -->
  <path d="M65 75 Q90 40 115 75 Q110 60 90 65 Q70 60 65 75 Z" fill="#2D2D2D"/>
  <!-- Laptop -->
  <rect x="60" y="135" width="60" height="18" rx="4" fill="#333"/>
  <rect x="65" y="140" width="50" height="8" rx="2" fill="#C0C0C0"/>
  <circle cx="90" cy="144" r="2" fill="#999"/>
</svg>
</p>
